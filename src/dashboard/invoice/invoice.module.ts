...
@Module({
  imports: [MongooseModule.forFeature([{ name: Invoice.name, schema: InvoiceSchema }]), InvoicePartiesModule, ProductsModule, UsersModule, JwtConfigModule], // Asegúrate de importar el módulo de InvoiceParties aquí
